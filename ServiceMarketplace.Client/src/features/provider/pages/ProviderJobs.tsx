...
import { NearbyFilterPopover } from './components/NearbyFilterPopover'
import type { PagedResult, ServiceRequest } from '../../../shared/types/index'
          ...
          <div className="px-4 sm:px-5 py-4 border-b border-slate-100 flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            {activeTab === 'available' && canViewAll && (
              <NearbyFilterPopover
                ...
                onClear={() => { setNearbyResults(null); setShowNearby(false) }}
              />
            )}
          </div>
